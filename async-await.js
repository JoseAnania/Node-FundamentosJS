...
// función asincrona que retorna la información del empleado y su salario
const getInfo = async(id) => {

    const employee = await getEmployeeById(id);
    const salary = await getRemunerationById(id);

    return `El salario del empleado ${employee.name} es de $${salary.salary}`;
}
